...
const AppShell = ({ children }: { children: React.ReactNode }) => ( <div className="min-h-screen bg-[var(--bg-subtle)] text-[var(--text)]"> <header className="h-16 border-b border-border bg-white flex items-center px-4 justify-between"> <div className="flex items-center gap-3"> <img src="../public/anyai-logo.png" alt="AnyAI" className="h-7" /> <span className="text-sm text-muted">JCB Dashboard</span> </div> <div className="flex items-center gap-2"> <button className="btn btn-secondary">Export</button> </div> </header> <div className="flex"> <aside className="hidden lg:block w-64 border-r border-border bg-white p-3"> <nav className="space-y-1"> <a href="#" className="flex items-center gap-2 px-3 h-10 rounded-md bg-gray-50 border-l-4 border-primary text-ink">Dashboard</a> <a href="#" className="flex items-center gap-2 px-3 h-10 rounded-md hover:bg-gray-50">Analytics</a> <a href="#" className="flex items-center gap-2 px-3 h-10 rounded-md hover:bg-gray-50">Settings</a> </nav> </aside> <main className="flex-1 p-6 max-w-container mx-auto">{children}</main> </div> </div> );
